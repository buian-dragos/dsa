...
void testExtra(){
    ...
    ListIterator lastIndex = sil.lastIndexOf(3);

//    assert(lastIndex.getCurrent() == 3);

    lastIndex.next();

//    assert(lastIndex.getCurrent() == 4);

    cout << "Extra operation test passed\n";
